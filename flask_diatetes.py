...
"""
Pregnancies=2&Glucose=123&BloodPressure=70&SkinThickness=32&Insulin=25&BMI=33.7&DiabetesPedigreeFunction=0.34&Age=24
...
def predict():
    ...
    classifier               = joblib.load('diabetiesClassifier.svm')
